---
name: agent-reach
description: "Internet research router covering 13 platforms (Xiaohongshu, Twitter, Bilibili, Reddit, V2EX, LinkedIn, YouTube, GitHub, podcasts, RSS) with multi-backend routing (OpenCLI, per-platform CLIs, APIs). Use when searching the web, researching topics, or looking up content on any platform. See triggers for platform-specific activation patterns."
metadata:
  openclaw:
